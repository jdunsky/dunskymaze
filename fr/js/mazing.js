...
this.mazeCounter.appendChild(this.mazeScore);
  ...
  Mazing.prototype.heroTakeCharger = function() {
    ...
    this.heroScore += 10;
    this.setMessage("Vous avez récolté une borne de recharge !");
  ...
  Mazing.prototype.heroTakeThermo = function() {
    ...
    this.heroScore += 10;
    this.setMessage("Vous avez récolté un thermostat intelligent !");
    var audio = new Audio('gain.mp3');
    audio.loop = false;
    audio.play(); 
  }
...
Mazing.prototype.heroTakeSolar = function() {
  ...
  this.heroScore += 10;
  this.setMessage("Vous avez récolté un panneau solaire !");
  var audio = new Audio('gain.mp3');
    audio.loop = false;
    audio.play(); 
}
...
Mazing.prototype.heroTakeBio = function() {
  ...
  this.heroScore += 10;
  this.setMessage("Vous avez récolté de la bioénergie !");
  var audio = new Audio('gain.mp3');
    audio.loop = false;
    audio.play(); 
}
...
Mazing.prototype.heroTakeHeat = function() {
  ...
  this.heroScore += 10;
  this.setMessage("Vous avez récolté une thermopompe !");
  var audio = new Audio('gain.mp3');
    audio.loop = false;
    audio.play(); 
}
;
  ...
  Mazing.prototype.heroTakeKey = function() {
    ...
    this.setMessage("Vous avez récolté un chandail des Fêtes Dunsky !");
    var audio = new Audio('gain.mp3');
    audio.loop = false;
    audio.play(); 
  };
